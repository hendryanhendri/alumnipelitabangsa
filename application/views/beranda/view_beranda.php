			...
			<div class="container">
				<div class="header-data">
					...
					<div class="user-account">
						<div class="user-info">
							<img src="<?php echo base_url('photo/'.$this->session->userdata('photo'));?>" alt="" width="30px" height="40px">
							<a href="#" title=""><?php echo $this->session->userdata('nama_lengkap'); ?></a>
						...
						<div class="user-account-settingss">
							...
							<h3 class="tc"><a href="<?php echo base_url(); ?>index.php/Login/getKeluar" title="">Logout</a></h3>
							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									...
									<div class="tags-sec full-width">
										...
										<div class="cp-sec">
											<img src="<?php echo base_url(); ?>assets/images/alumni.png" alt="" width="100px" height="40px">
											<p><img src="<?php echo base_url(); ?>assets/images/cp.png" alt="">Copyright 2018</p>
										</div>
									</div><!--tags-sec end-->
								...
								<div class="main-ws-sec">
									...
									<div class="posts-section">
										<div class="post-bar">
											...
											<div class="epi-sec">
												<ul class="descp">
													<li><img src="<?php echo base_url(); ?>assets/images/icon8.png" alt=""><span>Epic Coder</span></li>
													<li><img src="<?php echo base_url(); ?>assets/images/icon9.png" alt=""><span>India</span></li>
												</ul>
												<ul class="bk-links">
							...
							<div class="col-lg-3 pd-right-none no-pd">
								<div class="right-sidebar">
									<div class="widget widget-about">
										<img src="<?php echo base_url(); ?>assets/images/PasangIklan.jpg" alt="" height="150" width="230px">
										<h3>Mau Pasang Iklan ?</h3>
										<span>Hubungi kami</span>
										<div class="sign_link">
											<h3><a href="#" title="">Check Here</a></h3>
											<a href="#" title=""></a>
										</div>
